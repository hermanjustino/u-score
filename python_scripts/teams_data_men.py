...
url = 'https://en.wikipedia.org/wiki/U_Sports_men%27s_basketball'  # Replace with the correct URL for women's basketball
                ...
                if next_sibling.name == 'table' and 'wikitable' in next_sibling.get('class', []):
                    ...
                    for row in rows[1:]:  # Skip the header row
                        ...
                        if len(cells) >= 7:  # Ensure the row has at least 7 columns
                            ...
                            ''', (university, varsity_name, city, province, founded, arena, capacity, 'men', conference))
